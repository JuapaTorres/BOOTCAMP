...
from validaciones import leer_entero, leer_float
import procesos
...
#Muestra las opciones disponibles en la consola.
    ...
    print("2. Visualizar inventario y totales")
...
#Controla el flujo principal mediante un bucle infinito hasta que el usuario decida salir.
    while True:
        ...
        if opcion == 1:
            ...
            stock = leer_entero("Ingrese cantidad inicial: ")
            precio = leer_float("Ingrese precio unitario: ")
